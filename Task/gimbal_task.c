...
#define Remote_dB 0.0005f
#define PC_dB 		0.0003f
...
{
	x=x+MOUSE_X_MOVE_SPEED*PC_dB;
	z=z+MOUSE_Y_MOVE_SPEED*PC_dB;
}
...
void gimbal_ctrl(void)
{
	...
	{	
		gimbal_rc_dbus();
//		CAN_cmd_gimbal_pitch(pid_gimbal[4].out,driver_out);
//		CAN_cmd_gimbal_yaw(pid_gimbal[2].out);
	...
	{	
		gimbal_rc_pc();
		CAN_cmd_gimbal_pitch(0,driver_out);
//		CAN_cmd_gimbal_yaw(pid_gimbal[2].out);
	}
